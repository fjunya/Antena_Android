...
public class SlidingTabsColorsFragment extends Fragment {
    ...
    static class SamplePagerItem {
        ...
        SamplePagerItem(CharSequence title, int indicatorColor, int dividerColor, int position) {
            mTitle = title;
        ...
        Fragment createFragment() {
            if(mPosition == 0){
                return LoderFragment.newInstance(mTitle, mIndicatorColor, mDividerColor);
            }else{
